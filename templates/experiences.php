<section id="experience">
    ...
    <div class="container lightblue">
        <div class="exp">
            <div class="img">
                <img src="../img/logoC&A.png" alt="Logo C&A">
            </div>
            <div class="text">
        ...
        <div class="exp">
            <div class="img">
                <img src="../img/Mango-logo.png" alt="Logo Mango">
            </div>
            <div class="text">
                <h4>Assistante Manager</h4>
                <li><i class="far fa-calendar-check"></i> Janvier 2019 à Août 2019 <i class="fas fa-map-marker-alt"></i> CC Confluence, Lyon (69)</li>
            </div>
        </div>
        <br>
        <hr>
        <div class="exp">
            <div class="img">
                <img src="../img/AT-logo.png" alt="Logo Armand Thiery">
            </div>
            <div class="text">
        ...
        <div class="exp">
            ...
            <div class="text">
                <h4>Assistante Manager</h4>
                <li><i class="far fa-calendar-check"></i> 2008-2018 <i class="fas fa-map-marker-alt"></i> Plusieurs magasins en régions lyonnaise et parisienne </li>
            </div>
        </div>
        <br>
        <hr>
        <div class="exp">
            <div class="img">
                <img src="../img/logo-KIABI2.png" alt="Logo Kiabi">
            </div>
            <div class="text">
                <h4>Conseillère de Vente</h4>
                <li><i class="far fa-calendar-check"></i> 2007 <i class="fas fa-map-marker-alt"></i> Amiens (80)</li>
            </div>
        </div>
        <br>
        <hr>
        <div class="exp">
            <div class="img">
                <img src="../img/xanaka-logo.png" alt="Logo Xanaka">
            </div>
            <div class="text">
                <h4>Conseillère de Vente</h4>
